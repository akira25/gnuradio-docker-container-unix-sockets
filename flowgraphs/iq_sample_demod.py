...
class iq_sample_demod(gr.top_block):
    ...
    def __init__(self):
        ...
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'ipc://@iq_samples.sock', 100, False, (-1), '', False)
        self.zeromq_pub_sink_0_0 = zeromq.pub_sink(gr.sizeof_short, 1, 'ipc://@out_short.sock', 100, False, (-1), '', True, True)
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_float, 1, 'ipc://@out_float.sock', 100, False, (-1), '', True, True)
        ...
        self.connect((self.blocks_float_to_short_0, 0), (self.zeromq_pub_sink_0_0, 0))
...
def main(top_block_cls=iq_sample_demod, options=None):
    tb = top_block_cls()
